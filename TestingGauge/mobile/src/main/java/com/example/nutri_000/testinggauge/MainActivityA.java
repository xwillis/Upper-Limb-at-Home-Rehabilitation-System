...
import com.example.nutri_000.testinggauge.settings.SettingsActivity;
import com.example.nutri_000.testinggauge.update.FirmwareUpdater;
import com.example.nutri_000.testinggauge.update.ReleasesParser;
import com.example.nutri_000.testinggauge.ble.BleDevicesScanner;
import com.example.nutri_000.testinggauge.ble.BleManager;
import com.example.nutri_000.testinggauge.ble.BleUtils;
import com.example.nutri_000.testinggauge.ui.utils.DialogUtils;
import com.example.nutri_000.testinggauge.ui.utils.ExpandableHeightExpandableListView;
...
public class MainActivityA extends AppCompatActivity implements BleManager.BleManagerListener, BleUtils.ResetBluetoothAdapterListener, FirmwareUpdater.FirmwareUpdaterListener {
    // Constants
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_ada);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_help) {
            ...
            intent.setClass(MainActivityA.this, SettingsActivity.class);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BleUtils.enableWifi(true, MainActivityA.this);
                            MainActivityA.super.onBackPressed();
                        }
...
/*
    ...
    public void onClickDeviceConnect(int scannedDeviceIndex) {
        ...
        if (scannedDeviceIndex < filteredPeripherals.size()) {
            ...
            mBleManager.setBleListener(MainActivityA.this);           // Force set listener (could be still checking for updates...)
...
//            Log.d(TAG, "record -> lenght: " + length + " type:" + type + " data" + data);
    ...
    private void launchComponentActivity() {
        ...
        if (mComponentToStartWhenConnected != null) {
            ...
            Intent intent = new Intent(MainActivityA.this, mComponentToStartWhenConnected);
        ...
        if (isFailedInstallationDetected) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    new AlertDialog.Builder(MainActivityA.this)
                            ...
                            .setPositiveButton(R.string.scan_failedupdatedetected_ok, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    mFirmwareUpdater.startFailedInstallationRecovery(MainActivityA.this);
                                }
                            })
                            .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    FirmwareUpdater.clearFailedInstallationRecoveryParams(MainActivityA.this);
                    ...
                    new AlertDialog.Builder(MainActivityA.this)
                            ...
                            .setPositiveButton(R.string.scan_softwareupdate_install, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    mFirmwareUpdater.downloadAndInstall(MainActivityA.this, latestRelease);
                                }
                            })
