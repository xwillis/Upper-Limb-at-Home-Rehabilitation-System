...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!= null){
            ...
            hipUI = new SensorUI(R.id.upperLegButton,R.id.progressBarTopRight, R.id.progressBarTopLeft, R.id.seekBarTopRight, R.id.seekBarTopLeft, R.id.topAngle, R.id.topAngleL,
                    R.id.progressBarTopRightY, R.id.progressBarTopLeftY, R.id.seekBarTopRightY, R.id.seekBarTopLeftY, R.id.topAngleY, R.id.topAngleLY,
                    R.id.progressBarTopRightZ, R.id.progressBarTopLeftZ, R.id.seekBarTopRightZ, R.id.seekBarTopLeftZ, R.id.topAngleZ, R.id.topAngleLZ, R.id.relativeHip, this );
            //x axis
            hipUI.leftPB.setRotation(180);
            //y axis
            hipUI.leftPBY.setRotation(180);
            //z axis
            hipUI.leftPBZ.setRotation(180);
            ...
            kneeUI = new SensorUI(R.id.lowerLegButton, R.id.progressBarMidRight, R.id.progressBarMidLeft, R.id.seekBarMidRight,R.id.seekBarMidLeft, R.id.midAngle, R.id.midAngleL,
                    R.id.progressBarMidRightY, R.id.progressBarMidLeftY, R.id.seekBarMidRightY,R.id.seekBarMidLeftY, R.id.midAngleY, R.id.midAngleLY,
                    R.id.progressBarMidRightZ, R.id.progressBarMidLeftZ, R.id.seekBarMidRightZ,R.id.seekBarMidLeftZ, R.id.midAngleZ, R.id.midAngleLZ,R.id.relativeKnee, this);
            //x axis
            kneeUI.leftPB.setRotation(180);
            //y axis
            kneeUI.leftPBY.setRotation(180);
            //z axis
            kneeUI.leftPBZ.setRotation(180);

            kneeUI.green = R.drawable.kneegreen;
            kneeUI.yellow = R.drawable.kneeyellow;
            kneeUI.white = R.drawable.kneewhite;

            ankleUI = new SensorUI(R.id.footButton,R.id.progressBarBottomRight,R.id.progressBarBottomLeft,R.id.seekBarBottomRight,R.id.seekBarBottomLeft, R.id.bottomAngle,R.id.bottomAngleL,
                    R.id.progressBarBottomRightY,R.id.progressBarBottomLeftY,R.id.seekBarBottomRightY,R.id.seekBarBottomLeftY, R.id.bottomAngleY,R.id.bottomAngleLY,
                    R.id.progressBarBottomRightZ,R.id.progressBarBottomLeftZ,R.id.seekBarBottomRightZ,R.id.seekBarBottomLeftZ, R.id.bottomAngleZ,R.id.bottomAngleLZ, R.id.relativeAnkle, this);
            //x axis
            ankleUI.leftPB.setRotation(180);
            //y axis
            ankleUI.leftPBY.setRotation(180);
            //z axis
            ankleUI.leftPBZ.setRotation(180);
    ...
    public void setGaugeValueY(final int value, final SensorUI sensor) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if ( (value*-1) > sensor.leftSBY.getProgress() & (value*-1) < 90 ){
                    sensor.relativeLayout.setBackgroundColor(Color.parseColor("#008542"));
                    if(!writeDebounce){
                        //writeFile(value, sensor);
                        writeDebounce = true;
            ...
            if (hipClickCount == 2) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //y
                        hipUI.leftTVY.setVisibility(View.INVISIBLE);
                        hipUI.rightTVY.setVisibility(View.INVISIBLE);
                        //z
                        hipUI.leftTVZ.setVisibility(View.INVISIBLE);
                        hipUI.rightTVZ.setVisibility(View.INVISIBLE);
                    }
                });
                hipClickCount = 0;
            }
            ...
            if(kneeClickCount == 2){
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //y
                        kneeUI.leftTVY.setVisibility(View.INVISIBLE);
                        kneeUI.rightTVY.setVisibility(View.INVISIBLE);
                        //z
                        kneeUI.leftTVZ.setVisibility(View.INVISIBLE);
                        kneeUI.rightTVZ.setVisibility(View.INVISIBLE);
                    }
                });
                kneeClickCount = 0;
            }
            ...
            if(footClickCount == 2){
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //y
                        ankleUI.leftTVY.setVisibility(View.INVISIBLE);
                        ankleUI.rightTVY.setVisibility(View.INVISIBLE);
                        //z
                        ankleUI.leftTVZ.setVisibility(View.INVISIBLE);
                        ankleUI.rightTVZ.setVisibility(View.INVISIBLE);
                    }
                });
                footClickCount = 0;
            }
    ...
    private void connectSensor(final SensorUI sensor){
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                //display y axis
                sensor.rightTVY.setVisibility(View.VISIBLE);
                sensor.leftTVY.setVisibility(View.VISIBLE);
                //display z axis
                sensor.rightTVZ.setVisibility(View.VISIBLE);
                sensor.leftTVZ.setVisibility(View.VISIBLE);
            }
        });
    }
    private void onSensorDisconnected(final SensorUI sensor){
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                //zero x axis progress bar and hide text value
                sensor.leftPB.setProgress(0);
                sensor.rightPB.setProgress(0);
                sensor.rightTV.setVisibility(View.INVISIBLE);
                sensor.leftTV.setVisibility(View.INVISIBLE);

                //zero y axis progress bar and hide text value
                sensor.leftPBY.setProgress(0);
                sensor.rightPBY.setProgress(0);
                sensor.rightTVY.setVisibility(View.INVISIBLE);
                sensor.leftTVY.setVisibility(View.INVISIBLE);

                //zero z axis progress bar and hide text value
                sensor.leftPBZ.setProgress(0);
                sensor.rightPBZ.setProgress(0);
                sensor.rightTVZ.setVisibility(View.INVISIBLE);
                sensor.leftTVZ.setVisibility(View.INVISIBLE);
